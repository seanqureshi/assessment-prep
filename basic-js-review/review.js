...
delete anakinSkywalker.former_mother;
delete anakinSkywalker.former_significant_other;
...
function whoAmI (object) {
  return object.name ? object.name : "has amnesia";
}
